...
type ArtifactGeneratorSpec struct {
	...
	// are injected as string variables into OutputArtifacts CEL expressions.
...
type OutputArtifact struct {
	...
	// When pathPattern is set, this field is evaluated as a CEL string expression.
	// +kubebuilder:validation:MinLength=1
	// +kubebuilder:validation:MaxLength=253
	// +required
	Name string `json:"name"`
...
type CopyOperation struct {
	...
	// this field is evaluated as a CEL string expression.
	// +kubebuilder:validation:Pattern="^(@([a-z0-9]([a-z0-9_-]*[a-z0-9])?)/(.*)|.*['\"+].*)$"
	// +kubebuilder:validation:MinLength=1
	// +kubebuilder:validation:MaxLength=1024
	// +required
	...
	// is set, this field is evaluated as a CEL string expression.
